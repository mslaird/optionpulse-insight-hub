...
const LeapsAlertsWidget = () => {
  const { dashboardLeapsAlerts, refreshAlerts } = useAIAlerts();
  
  return (
    <Card className="bg-card/30 backdrop-blur-sm border-emerald-500/30">
      <CardHeader className="pb-2 flex flex-row items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button 
            variant="ghost" 
            size="sm" 
            className="text-optionpulse-neutral hover:text-emerald-400"
